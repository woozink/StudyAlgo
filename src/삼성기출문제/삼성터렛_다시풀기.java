...
//            /*
//            1. 공격력이 가장 낮은 포탑을 기준으로 오름차순한다.
//            2. 공격력이 같다면, 공격한 시점을 기준으로 내림차순
//            3. 공격한 시점이 같다면, 행과 열의 합이 가장 큰 포탑을 기준으로 내림차순
...
//
//    // 상하좌우, 대각선 -> 포탄 공격에 사용
//    static int bdx[] = {-1, 1, 0, 0, -1, -1, 1, 1};
//    static int bdy[] = {0, 0, -1, 1, 1, -1, -1, 1};
//
//    static int N, M;
...
//                int ny = (N + turret.y + dy[i]) % N;
//
//                // 방문 하지 않았고, 부서지지 않은 포탑의 경우
